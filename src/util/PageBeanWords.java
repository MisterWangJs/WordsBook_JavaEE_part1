...
public class PageBeanWords<T> {
	...
	public PageBeanWords(int pageIndex, int count, int pageSize) {
		super();
	...
	public PageBeanWords(int pageIndex, int count, int pageSize, List<T> list) {
		super();
		this.pageIndex = pageIndex;
		this.count = count;
		this.pageSize = pageSize;
